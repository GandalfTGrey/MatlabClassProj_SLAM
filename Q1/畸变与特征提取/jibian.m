  clear;
    clc;
    A =[5.9418398977142772e+002 0 3.1950000000000000e+002;   %   A是内参数矩阵
        0    5.941839897714e+002 2.3950000000000000e+002;
        0 0 1];
    D = [6.7442695842244271e-002 2.4180872220967919e-001 0 0 -3.3970575589699975e-001];   %   D是外参数矩阵
    fx = A(1,1);
    fy = A(2,2);
    cx = A(1,3);
    cy = A(2,3);
    ...
    XYZc= inv(A)*[u v ones(length(u),1)]';   %XYZc是归一化平面的坐标
